ServerEvents.recipes(e => {//手动合成
    const { create } = e.recipes
    // create.item_application("wildfire:andesite_chassis",['create:andesite_casing','#tfc:chisels'],600,"none",true)//手动合成安山机箱
    // create.item_application('create:encased_fan',["wildfire:andesite_chassis",'wildfire:fan_blade'],600,"none",false)//手动合成鼓风机
    // create.item_application('create:mechanical_press',["wildfire:andesite_chassis",'wildfire:wrought_iron_pressing_head'],600,"none",false)//手动合成辊压机
